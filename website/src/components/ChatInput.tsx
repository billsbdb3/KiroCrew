...
interface ChatInputProps {
  ...
  approvalMode?: string
  /** Extra permission modes the live harness advertised (goose ``auto``). */
          ...
          <div className="flex items-center gap-0.5 min-w-0">
            ...
            <div className="relative min-w-0 flex-1">
              ...
              {!isMobile && approvalMode && (
                <ApprovalModePicker mode={approvalMode} slotKey={activeSlot || ''} permissionModes={permissionModes} />
              )}
              </div>
            ...
            {isMobile && approvalMode && (
              <ApprovalModePicker mode={approvalMode} slotKey={activeSlot || ''} permissionModes={permissionModes} compact />
            )}
          </div>
          <div className="flex items-center gap-1 shrink-0">
            {onVoiceToggle && (
